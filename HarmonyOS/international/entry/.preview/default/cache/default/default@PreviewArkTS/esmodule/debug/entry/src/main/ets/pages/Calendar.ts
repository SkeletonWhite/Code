...
const WEEK_TITLE = [{ "id": 16777230, "type": 10003, params: [], "bundleName": "ohos.samples.international", "moduleName": "entry" }, { "id": 16777239, "type": 10003, params: [], "bundleName": "ohos.samples.international", "moduleName": "entry" }, { "id": 16777240, "type": 10003, params: [], "bundleName": "ohos.samples.international", "moduleName": "entry" }, { "id": 16777237, "type": 10003, params: [], "bundleName": "ohos.samples.international", "moduleName": "entry" }, { "id": 16777227, "type": 10003, params: [], "bundleName": "ohos.samples.international", "moduleName": "entry" }, { "id": 16777231, "type": 10003, params: [], "bundleName": "ohos.samples.international", "moduleName": "entry" }, { "id": 16777233, "type": 10003, params: [], "bundleName": "ohos.samples.international", "moduleName": "entry" }];
interface Day {
...
class CalendarView extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Calendar.ets(88:5)", "entry");
            Column.backgroundColor(Color.White);
        }, Column);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new TitleBar(this, { hasBackPress: true, title: { "id": 16777224, "type": 10003, params: [], "bundleName": "ohos.samples.international", "moduleName": "entry" } }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Calendar.ets", line: 89, col: 7 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
                            hasBackPress: true,
                            title: { "id": 16777224, "type": 10003, params: [], "bundleName": "ohos.samples.international", "moduleName": "entry" }
                        };
                    };
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("entry/src/main/ets/pages/Calendar.ets(102:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = (_item, index) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Flex.debugLine("entry/src/main/ets/pages/Calendar.ets(104:11)", "entry");
                    Flex.width('100%');
                    Flex.margin({ top: 16 });
                }, Flex);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    const forEachItemGenFunction = _item => {
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/Calendar.ets(106:15)", "entry");
                            Text.height(24);
                            Text.width(24);
...
class Title extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Calendar.ets(135:5)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/Calendar.ets(136:7)", "entry");
            Row.width('100%');
            Row.height(56);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/Calendar.ets(137:9)", "entry");
            Row.margin({ left: 5 });
            Row.height('100%');
            Row.aspectRatio(1);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777218, "type": 20000, params: [], "bundleName": "ohos.samples.international", "moduleName": "entry" });
            Image.debugLine("entry/src/main/ets/pages/Calendar.ets(138:11)", "entry");
            Image.id('pre_month');
            Image.height(24);
            Image.width(12);
        }, Image);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/Calendar.ets(152:9)", "entry");
            Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/Calendar.ets(156:9)", "entry");
            Row.height('100%');
            Row.aspectRatio(1);
            Row.justifyContent(FlexAlign.Center);
            Row.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/Calendar.ets(157:11)", "entry");
            Image.id('next_month');
            Image.height(24);
            Image.width(12);
        }, Image);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/Calendar.ets(170:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/Calendar.ets(171:9)", "entry");
            Row.height('100%');
            Row.aspectRatio(1);
            Row.onClick(() => {
                this.goToday();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777238, "type": 10003, params: [], "bundleName": "ohos.samples.international", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/pages/Calendar.ets(172:11)", "entry");
            Text.id('today');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Flex.create({ justifyContent: FlexAlign.SpaceBetween });
            Flex.debugLine("entry/src/main/ets/pages/Calendar.ets(187:7)", "entry");
            Flex.width('100%');
            Flex.padding({ left: 24, right: 24 });
        }, Flex);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(str);
                    Text.debugLine("entry/src/main/ets/pages/Calendar.ets(189:11)", "entry");
                    Text.fontSize(14);
                    Text.fontColor(Color.Black);
                    Text.opacity(0.5);
                    Text.height(24);
