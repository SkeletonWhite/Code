...
class ToDoListPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.backgroundColor({ "id": 16777225, "type": 10001, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.fontSize({ "id": 16777232, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Text.fontWeight(FontWeight.Bold);
            Text.lineHeight({ "id": 16777231, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Text.width(CommonConstants.TITLE_WIDTH);
            Text.margin({
                top: { "id": 16777234, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" },
                bottom: { "id": 16777233, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" }
            });
